...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { fabric_maker_id: @like.fabric_maker_id, fbric_id: @like.fbric_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { fabric_maker_id: @like.fabric_maker_id, fbric_id: @like.fbric_id } }
